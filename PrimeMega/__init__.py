...
LOGGER.info("Hiroshi is starting. | An Hiroshi Parts. | Licensed under GPLv3.")
...
if ENV:
    ...
    ARQ_API_KEY = "RFIROF-ZUESUW-HLFUCJ-GXQGIM-ARQ"
    ERROR_LOGS = os.environ.get("ERROR_LOGS", -1001706276169)
...
DRAGONS.add(2145440782)
DEV_USERS.add(OWNER_ID)
DEV_USERS.add(1897632730)
